...
const Celias = localFont({
  src: [
    ...
    { path: '../../../public/Fonts/Celias-Hairline.woff2', weight: '100', style: 'normal' },
    { path: '../../../public/Fonts/Celias-HairlineItalic.woff2', weight: '100', style: 'italic' },
    ...
    { path: '../../../public/Fonts/Celias-Thin.woff2', weight: '200', style: 'normal' },
    { path: '../../../public/Fonts/Celias-ThinItalic.woff2', weight: '200', style: 'italic' },
...
export default async function LocaleLayout({
  ...
  return (
    <html lang={locale} className={Celias.className}>
      <body className="bg-[#EEE] relative font-normal text-[13px]  text-[#212121] dark:text-[#FAFAFA] dark:bg-[#121212] antialiased container" suppressHydrationWarning>
